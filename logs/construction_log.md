...
| C004 | 2026-07-18 | v1.0 | （待commit回填） | 卷一 cluster D（第977-1007行）+ E（第1479-1814行） | 11 | 3 | 0.27 | 8 | 1 | 1 | 0 |  | 无 | D是无关旁涉提及（0 CEU），E是大段守护者集会场景，3条CEU覆盖效忠仪式/嫉妒爆发/恐惧顺从。schema_violations_caught=1不是CEU内容错误，是发现`_index_vol1.yaml`本身有重复键bug（cluster C此前一直被误标为pending），已修复，详见revision_log。candidate_scenes/skipped_with_reason把D和E合并统计（D的1个节拍全部跳过，E的10个节拍里3个被采纳） |
