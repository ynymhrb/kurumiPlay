...
| C005 | 2026-07-18 | v1.0 | （待commit回填） | 卷一 cluster F（第1876-1975行）+ G（第1987-2017行）+ H（第2059-2119行） | 5 | 3 | 0.6 | 2 | 0 | 1 | 0 |  | 无 | G无CEU（旁涉提及），F/H各产出1/2条。这批开始吸取此前重复键bug的教训，直接编辑trailing block而非在mention_lines前插入，本次validate_ceu.py全程0错误，说明这个流程问题已经解决。yield_rate明显提升（0.6 vs 之前普遍0.2左右），可能是因为这几个cluster本身内容更集中（少铺垫场景，多直接互动） |
