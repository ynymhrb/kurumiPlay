...
1. **卷十四干净盲测**（test阶段收官）：检验v0.9+协议v1.1相对0.55基线的增益——这是唯一未被污染的度量点
2. 遗留：value_hierarchy第3/5层仍无正式证据；MM2/MM4/MM6/MM7三重验证回填；依恋创伤机制需更多危机场景；翅膀通道候选待跨场景验证
3. 可选：卷十二验证集同法调试（新鲜度低于卷十四，但可再迭代一轮协议）

---
最后更新：2026-07-20（卷十一dev盲测调试0.57/机制0.80；profile v0.9；prediction_protocol v1.1）
